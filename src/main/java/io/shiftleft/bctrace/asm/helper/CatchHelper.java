...
public class CatchHelper {
  ...
  public static void addTraceThrowableUncaught(MethodNode mn, LabelNode startNode, int frameDataVarIndex, ArrayList<Integer> hooksToUse) {
  ...
  private static void addCatchBlock(MethodNode mn, LabelNode startNode, LabelNode endNode, int frameDataVarIndex, ArrayList<Integer> hooksToUse) {
  ...
  private static InsnList getThrowableTraceInstructions(int frameDataVarIndex, ArrayList<Integer> hooksToUse) {
    InsnList il = new InsnList();
