 ...
 * the framework performs an initial query to the {@link #instrumentClass(String, ProtectionDomain,
 * ClassLoader) instrumentClass} method. If this return <code>true</code> the class bytecode is
 * parsed and the filter {@link #instrumentClass(BctraceClass, ProtectionDomain, ClassLoader)
 * instrumentMethod} is called. It this other returns true the filter {@link
 * #instrumentMethod(BctraceClass, MethodNode) instrumentMethod} method will be invoked once per non
